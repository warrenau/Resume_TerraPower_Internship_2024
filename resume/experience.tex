...
\begin{cventries}
  ...
  \cventry
    ...
    {September 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        %\item{First PhD student of new professor.}
  ...
  \cventry
    ...
    {June 2023 - September 2023}
    {
      \begin{cvitems}
          ...
          %\item {Investigated the impact of cladding deformation on operating temperatures.}
          %\item {Investigated the impact of design parameters and dimensional tolerances on operational conditions.}
          ...
          %\item {Compared model results to validation experiments, calibrated models, and quantified model uncertainties.}
  ...
  \cventry
    ...
    {Oregon State University} % Organization
    {Corvallis, OR} % Location
    {September 2021 - September 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
